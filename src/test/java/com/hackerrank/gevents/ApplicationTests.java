...
public class ApplicationTests {
    ...
    private Map<String, Event> getTestData() {
        ...
        Event event_01_push_actor_1 = new Event(1,
                "PushEvent",
                true,
                1,
                1);
        ...
        Event event_01_release_actor_1 = new Event(1,
                "ReleaseEvent",
                true,
                1,
                1);
        ...
        Event event_01_watch_actor_1 = new Event(1,
                "WatchEvent",
                true,
                1,
                1);
        ...
        Event event_02_watch_actor_1 = new Event(1,
                "WatchEvent",
                true,
                2,
                1);
        ...
        Event event_02_watch_actor_2 = new Event(1,
                "WatchEvent",
                true,
                2,
                2);
